...
class EventBooking(Document):
	...
	def create_quotation(self):
		...
		if not self.customer:
			frappe.throw("Cannot create Quotation without a Customer.")
		if not self.services:
			frappe.throw("Cannot create Quotation without any Service Items.")
	...
	def create_material_request(self):
		...
		if not settings.default_warehouse:
			frappe.throw("Set a Default Warehouse in Event Settings before creating a Material Request.")
